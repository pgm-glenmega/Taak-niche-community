<article class="mt-8">
    <div class="flex justify-between items-center p-4">
        <h1 class="text-5xl text-white font-bold">Created workouts</h1>
        ...
        @forelse ($workouts as $workout)
            <div class="bg-white rounded-lg overflow-hidden shadow-md">
                ...
                <div class="bg-gray-100 p-4 flex justify-between">
                    ...
                    <a href="{{ route('userworkouts.edit', ['id' => $workout->id]) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white px-4 py-2 rounded-md">Edit Workout</a>
                </div>
            </div>
        @empty
